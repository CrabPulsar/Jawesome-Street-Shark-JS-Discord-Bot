...
// const google = new Scraper({puppeteer: {headless: false}, executablePath: 'chromium-browser', args:[]});
module.exports.run = async (bot, message, args) =>{

return message.reply("This command is not working at the moment.")
...
if (msgContent.startsWith('images')) {msgContent = msgContent.slice(7)}
else {msgContent = msgContent.slice(2)}
